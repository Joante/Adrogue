	...
	<div class="divGeneral container">
		<section class="main row">
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9" >
				...
				<br>
				<h2>ADMINISTRADOR</h2>
				<a href="#ventana5" class="btn btn-primary btn-md" data-toggle="modal">ESTADISTICAS COLECTIVO</a>
				<br>
				<br>
				<br>
				<a href="#ventana6" class="btn btn-primary btn-md" data-toggle="modal">ESTADISTICAS TREN</a>
				<br>
				<br>
				<br>
				<a href="#ventana7" class="btn btn-primary btn-md" data-toggle="modal">ESTADISTICAS SUBTE</a>
				<br>
				<br>
				<br>
						...
						<div class="modal-body">
							<div class="formulario container">
								<form action="/SistemaSubeV3/MovimientoTren" id="form1" onsubmit="return validar1();">
									...
									<h4>Hora bajada</h4>
									<input type="text" placeholder="Hora" name="horaB" id="hora2">
									<input type="text" placeholder="Minutos" name="minutosB" id="min2">
			...
			<div class="modal fade" id="ventana5">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-header">
							<button title="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h3 class="modal-tittle">CONSULTAS</h3>
						</div>
						<!-- body de la ventana-->
						<div class="modal-body">
							<div class="formulario container">
								<form action="/SistemaSubeV3/EstadisticasColectivo">
			...
			<div class="modal fade" id="ventana6">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="formulario container">
								<form action="/SistemaSubeV3/EstadisticasTren">
								<h4>Ingrese la fecha desde</h4>
									<input type="text" placeholder="Año" name="anioD" required>
									<input type="text" placeholder="Mes" name="mesD" required>
									<input type="text" placeholder="Dia" name="diaD" required>
			...
			<div class="modal fade" id="ventana7">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="formulario container">
								<form action="/SistemaSubeV3/EstadisticasSubte">
								<h4>Ingrese la fecha desde</h4>
									<input type="text" placeholder="Año" name="anioD" required>
									<input type="text" placeholder="Mes" name="mesD" required>
									<input type="text" placeholder="Dia" name="diaD" required>
