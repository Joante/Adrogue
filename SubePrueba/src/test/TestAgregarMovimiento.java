...
public class TestAgregarMovimiento {
	...
	public static void main(String[] args) {
		...
		try {
			movimiento.agregarMovimiento(fecha,6061268125294963l, 1, 6 );
		} catch (Throwable e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		try {
			//movimiento.agregarMovimiento(fecha, 6061268125294963l, 2, 2);
		} catch (Throwable e) {
			// TODO Auto-generated catch block
			System.out.println(""+e.getMessage());
		}
		try {
			//movimiento.agregarMovimiento(fecha, 6061268125294963l, 4, 0);
		} catch (Exception e) {
			// TODO Auto-generated catch block
